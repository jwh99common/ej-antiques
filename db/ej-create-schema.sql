...
drop table if exists ej_antiques_products;
drop table if exists ej_antiques_merchandise;
drop table if exists ej_antiques_services;
drop table if exists ej_antiques_gallery;
drop table if exists ej_antiques_blogs;
drop table if exists ej_antiques_orders;
